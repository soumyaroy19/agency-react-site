...
const Navbar = ({ theme, setTheme }) => {
    ...
    return (
        ...
        className='flex justify-between items-center px-4 sm:px-12 lg:px-24 sl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/90 dark:bg-gray-900/70'>
            ...
            max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
                ...
                <img src={assets.close_icon} alt="" className='w-5 absolute right-4 top-4 sm:hidden' onClick={()=>{
