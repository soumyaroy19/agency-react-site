...
const Footer = ({ theme }) => {
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-8 sm:mt-16 px-4 sm:px-10 lg:px-24 xl:px-40'>
            ...
            <motion.div
                ...
                <p>Copyright 2025 © Agency Project. All rights reserved.</p>
